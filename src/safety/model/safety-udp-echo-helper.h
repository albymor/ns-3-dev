 ...
 */
#ifndef SAFETY_UDP_ECHO_HELPER_H
#define SAFETY_UDP_ECHO_HELPER_H
 ...
 */
class SAFETYUdpEchoServerHelper
{
public:
  /**
   * Create SAFETYUdpEchoServerHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  SAFETYUdpEchoServerHelper (uint16_t port);

  SAFETYUdpEchoServerHelper (uint16_t port, float wdt_period);
 ...
 */
class SAFETYUdpEchoClientHelper
{
public:
  /**
   * Create SAFETYUdpEchoClientHelper which will make life easier for people trying
   ...
   */
  SAFETYUdpEchoClientHelper (Address ip, uint16_t port);
  /**
   * Create SAFETYUdpEchoClientHelper which will make life easier for people trying
   * to set up simulations with echos. Use this variant with addresses that do
   ...
   */
  SAFETYUdpEchoClientHelper (Address addr);
  ...
  void SetFailSafeManager (Ptr<Application> app, Ptr<FailSafeManager> failSafeManager);
